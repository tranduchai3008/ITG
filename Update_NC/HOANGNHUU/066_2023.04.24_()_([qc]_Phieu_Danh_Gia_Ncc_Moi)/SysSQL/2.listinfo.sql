...
DELETE FROM listinfo WHERE code in ('QC3Tran');
...
('QC3Tran','so_ct','phxx','ngay_ct, so_ct','1=1','1=1','tag, ngay_ct,  so_ct, ma_kh, ten_kh, dia_chi,  dien_giai','tag, ngay_ct,  so_ct, ma_kh, ten_kh2, dia_chi, dien_giai','Chọn, Ngày ct,  Số ct, Mã ncc, Tên ncc, Địa chỉ, Diễn giải','Chọn, Ngày ct,  Số ct, Mã ncc, Tên ncc, Địa chỉ, Diễn giải','CHECKBOX, DATE,  , , , , ','40, 80,  80, 80, 200, 200, 200','Chọn','Select request','Thêm','Add','Sửa','Edit','','','','0','1','');
