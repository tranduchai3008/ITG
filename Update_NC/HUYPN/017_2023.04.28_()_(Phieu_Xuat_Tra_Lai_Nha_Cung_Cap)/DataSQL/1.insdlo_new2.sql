...
DECLARE
	...
	-- SELECT * FROM insdlo_new2('KTP', '2023-05-08', '00001', 'A1000000024095125PXC', '', '', 'CHIEC', 'PO0002', '08052023') ORDER BY ngay_nhap DESC
BEGIN
	...
	from dmlo b
	where a.ma_vt = b.ma_vt 
		and a.ma_lo = b.ma_lo AND b.po_khsx = cpo_khsx and b.dau_tuan = cdau_tuan;
	...
	FOR r IN select * from tmp WHERE (po_khsx <> '' or dau_tuan <> '')ORDER BY ngay_nhap 
        LOOP
		RETURN NEXT r;
	END LOOP;
